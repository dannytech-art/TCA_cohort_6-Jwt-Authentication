const signUpTemp =(verifyLink,firstName)=>{
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
const verifyTemp =(verifyLink,firstName)=>{
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
const resetPasswordTemp =(verifyLink,firstName)=>{
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Hello ${firstName},</p>
                <p>A reset password was initiated on your account,</p>
                <p>please click the button below to reset your password:</p>
                <div class="button-container">
                    <a href="${verifyLink}" class="button">resetPassword</a>
                </div>
                <p>If you did not request for a resetPassword, kindly ignore this email.</p>
                <p>Best regards,<br>MR Josh</p>
            </div>
            <div class="footer">
                <p>&copy; ${new Date().getFullYear()} . All rights reserved.</p>
